...
<html>
  ...
  <body>
    <header>
      ...
      <button id="historyBtn" type="button" title="Saved chats">History</button>
    ...
    <script nonce="${nonce}">
      ...
      historyBtn.addEventListener("click", () =>
        toggleChatHistory(chatHistoryEl.hidden),
      );
